...
//$resultado = $controlTest->actualizarEstadoReserva('ZMT5', 'PA', 'E', 50.0, '', '', 2);
//echo $resultado;

$resultado = $controlTest->crearReserva('ida', 2, 2, 0, '2009-03-22', 1, 1, 111, 17706708, null, null, null, 'PP');
echo $resultado;
